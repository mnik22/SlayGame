...
public class Driver extends Application {
    ...
    private static final int NUM_TILES = 54;
    private Tile[][] GUIMap;
    ...
    public void start(Stage primaryStage) {
        ...
        while(count < NUM_TILES)
        {
            ...
            if(tilesRemaining[rndPlayer] > 0)
            {
                ...
                placeTile(temp, CENTER_TILE_INDEX_W, CENTER_TILE_INDEX_H +1, CENTER_TILE_GUI_INDEX_ROW +1, CENTER_TILE_GUI_INDEX_COLUMN);
                count++;
        ...
        switch(rndPos) {
            ...
            case 1: //top
                if(tileGuiIndexRow > 2 && tileGuiIndexColumn > 1 && tileGuiIndexRow < GUIMap.length - 2 && tileGuiIndexColumn < GUIMap[0].length -1 && GUIMap[tileGuiIndexRow+2][tileGuiIndexColumn] == null) {
                    ...
                    placeTile(t, tileIndexW, tileIndexH +2, tileGuiIndexRow+1, tileGuiIndexColumn);
                else
                    return;
                break;
            case 2: // top right
